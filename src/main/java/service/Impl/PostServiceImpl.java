...
public class PostServiceImpl implements PostService {
	...
	public String post(PostEntity entity) {
		...
		User user=userDAO.getUserByName(entity.getUsername());
		if(user!=null){
	...
	public PostEntity analysis(String PostItem) {
		...
		return new PostEntity(username, msgid, title, date, autor, state, canopen, type);
	}
